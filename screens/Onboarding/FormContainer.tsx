...
const FormContainer: React.FC<FormContainerProps> = ({ initialData, onFinish, onBackToLanding }) => {
  ...
  const handleUpdate = useCallback(
    (field: keyof UserProfile, value: string | number | string[]) => {
  ...
  return (
    <OnboardingLayout>
      ...
      <div className="mt-8 flex justify-between sticky bottom-0 bg-emerald-50 dark:bg-gray-800 pt-4 -mx-10 px-10 rounded-b-2xl shadow-inner">
