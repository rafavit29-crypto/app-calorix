...
interface SummaryScreenProps {
  ...
  onEdit: () => void;
  onConfirm: () => void;
  isConfirmed: boolean; // New prop for confirmation status
}

const SummaryScreen: React.FC<SummaryScreenProps> = ({ profileData, onEdit, onConfirm, isConfirmed }) => {
  ...
  return (
    <Layout>
      ...
      {isConfirmed && (
        <div
          role="alert"
          className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg relative mb-6 text-center transition-all duration-300 ease-in-out"
        >
      ...
      <div className="space-y-6 mb-8 text-left text-gray-700">
        {/* Section 1: Perfil do Usuário */}
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-emerald-700 mb-4">{FORM_SECTIONS[0]}</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-emerald-700 mb-4">{FORM_SECTIONS[1]}</h2>
        ...
        {/* Section 3: Objetivos */}
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-emerald-700 mb-4">{FORM_SECTIONS[2]}</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-emerald-700 mb-4">{FORM_SECTIONS[3]}</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-emerald-700 mb-4">{FORM_SECTIONS[4]}</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-emerald-700 mb-4">{FORM_SECTIONS[5]}</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-emerald-700 mb-4">{FORM_SECTIONS[6]}</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-emerald-700 mb-4">{FORM_SECTIONS[7]}</h2>
